document.addEventListener('DOMContentLoaded', function() {
    ...
    var wmsLayers = [
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Investigacion_Cultured_Maps:Subindice_de_Inclusion_e_identidades_sociales_diversas_2021', displayName: 'Subindice_Inclusion_e_identidades_sociales_diversas_2021' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Investigacion_Cultured_Maps:Subindice_de_Inclusion_e_identidades_sociales_diversas_2023', displayName: 'Subindice_Inclusion_e_identidades_sociales_diversas_2023' }
    ];
